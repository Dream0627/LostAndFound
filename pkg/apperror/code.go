...
var (
	...
	AppealNotFoundError             = NewError(404, "申诉不存在")
	InvalidAppealReasonError        = NewError(400, "无效的申诉原因")
	InvalidAppealStatusError        = NewError(400, "无效的申诉状态")
	AppealNotPendingError           = NewError(400, "该申诉不可审核")
	...
	MessageNotFoundError            = NewError(404, "消息不存在")
	FinishRequestNotFoundError      = NewError(404, "完成申请不存在")
	ConversationForbiddenError      = NewError(403, "无权参与该对话")
	PostAlreadyFinishedError        = NewError(409, "该帖子已完成")
